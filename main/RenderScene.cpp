...
namespace gpr5300
{
	...
	void RenderScene::SetPointLights()
	{
	...
	void RenderScene::RenderDownsamples(BloomRenderer& bloomRenderer, unsigned int srcTexture)
	{
	...
	void RenderScene::RenderUpsamples(BloomRenderer& bloomRenderer, float filterRadius)
	{
		const std::vector<bloomMip>& mipChain = bloomRenderer.mFBO.MipChain();
	...
	void RenderScene::RenderBloomTexture(BloomRenderer& bloomRenderer, unsigned int srcTexture, float filterRadius)
	{
	...
	void RenderScene::renderEnvironmentCube()
	{
		// initialize (if necessary)
		if (cubeVAO == 0)
		{
	...
	float RenderScene::ourLerp(float a, float b, float f)
	{
		return a + f * (b - a);
	}
...
#pragma region Shader Loading
		...
		pipelines.emplace_back(
			...
			"data/shaders/RenderScene/geom_pass.frag");
		//Lighting pass 1
		pipelines.emplace_back(
			"data/shaders/RenderScene/light_pass.vert",
			"data/shaders/RenderScene/light_pass.frag");
		//Light Boxes 2
		pipelines.emplace_back(
			"data/shaders/RenderScene/simple_box.vert",
			"data/shaders/RenderScene/simple_box.frag");
		//SSAO 3
		pipelines.emplace_back(
			"data/shaders/RenderScene/ssao.vert",
			"data/shaders/RenderScene/ssao.frag");
		//SSAO 4
		pipelines.emplace_back(
			"data/shaders/RenderScene/ssao.vert",
			"data/shaders/RenderScene/ssao_blur.frag");

		//IBL

		//equirectangularToCubemapShader 5
		pipelines.emplace_back(
			"data/shaders/RenderScene/cubemap.vert",
			"data/shaders/RenderScene/equirectangular_to_cubemap.frag");
		//irradianceShader 6
		pipelines.emplace_back(
			"data/shaders/RenderScene/cubemap.vert",
			"data/shaders/RenderScene/irradiance_convolution.frag");
		//prefilterShader 7
		pipelines.emplace_back(
			"data/shaders/RenderScene/cubemap.vert",
			"data/shaders/RenderScene/prefilter.frag");
		//brdfShader 8
		pipelines.emplace_back(
			"data/shaders/RenderScene/brdf.vert",
			"data/shaders/RenderScene/brdf.frag");
		//backgroundShader 9
		pipelines.emplace_back(
			"data/shaders/RenderScene/background.vert",
			"data/shaders/RenderScene/background.frag");

		//Shadow 10
		pipelines.emplace_back(
			"data/shaders/RenderScene/shadow_map.vert",
			"data/shaders/RenderScene/shadow_map.frag");
...
#pragma endregion
	...
	void RenderScene::DrawScene(Pipeline& pipeline, std::vector<Model> models)
	{

...
namespace gpr5300
{
	...
	bool BloomRenderer::Init(unsigned int windowWidth, unsigned int windowHeight)
	{
		...
		// Shaders
		mDownsampleShader = new Pipeline("data/shaders/RenderScene/downsample.vert", "data/shaders/RenderScene/downsample.frag");
		mUpsampleShader = new Pipeline("data/shaders/RenderScene/downsample.vert", "data/shaders/RenderScene/upsample.frag");
